...
animation <- df100m %>% 
  ...
  labs(
    ...
    x = "Splits",
    color = "Runner",
    title="Comparison of Top 100 Meter \nDashed Runners"
  ) +
...
## save to disk
magick::image_write(image = animation,
            path = "100m_animation.gif")

class(animation)

anim_save("100m_animation.gif", animation)
